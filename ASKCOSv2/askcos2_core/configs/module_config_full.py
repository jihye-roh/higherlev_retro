module_config = {
    ...
    "retro_template_relevance": {
        ...
        "deployment": {
            ...
            "available_model_names": [
                ...
                "reaxys",
                "reaxys_biocatalysis",
                "uspto_higher-level_consol",
                "uspto_higher-level_nonconsol",
                "uspto_original_consol",
                "uspto_original_nonconsol",
                "test_consol", 
                "test_nonconsol"
            ]
        }
    ...
    "pricer": {
        ...
        "database": "askcos",
        "collection": "buyables",
        "tree_search_collection": "buyables_tree_search",
        "file": "",
        "precompute_mols": False,
        "preload_buyables": True # preload buyables in memory # TODO: change
    },
